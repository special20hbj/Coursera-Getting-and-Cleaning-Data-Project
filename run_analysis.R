...
download.file(fileUrl, destfile = "/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/getdata.zip", method = "curl")
listzip <- unzip("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/getdata.zip", exdir = "/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment")

## Step1. Merges the training and the test sets to create one data set ##
## Load the data into R ##
test_x <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/test/X_test.txt")
dim(test_x)
head(test_x, n=3)
test_y <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/test/y_test.txt")
dim(test_y)
head(test_y, n=3)
test_subject <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/test/subject_test.txt")
dim(test_subject)
head(test_subject, n=3)
train_x <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/train/X_train.txt")
dim(train_x)
head(train_x, n=3)
train_y <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/train/y_train.txt")
dim(train_y)
head(train_y, n=3)
train_subject <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/train/subject_train.txt")
dim(train_subject)
...
features <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/features.txt")
dim(features)
...
activity_labels <- read.table("/Users/HBJ/Documents/Coursera/Getting and Cleaning Data/assignment/UCI HAR Dataset/activity_labels.txt")
dim(activity_labels)
